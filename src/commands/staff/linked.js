    ...
    if (userAccount == null) {
      ...
      if (typeof userAccount == "string") {
        ...
        await message.channel.send(
          "The user account was not in the correct format."
        );
      }
      ...
      const Embed = new Discord.EmbedBuilder()
        ...
        .addFields(
          {
            name: "__**Username**__",
            value: userAccount.username.toString(),
            inline: false,
          },
          {
            name: "__**Email**__",
            value: userAccount.email.toString(),
            inline: false,
          },
          {
            name: "__**Discord ID**__",
            value: userAccount.discordID.toString(),
            inline: false,
          },
          {
            name: "__**Console ID**__",
            value: userAccount.consoleID.toString(),
            inline: false,
          },
          {
            name: "__**Date (YYYY/MM/DD)**__",
            value: userAccount.linkDate.toString(),
            inline: false,
          },
          {
            name: "__**Time**__",
            value: userAccount.linkTime.toString(),
            inline: false,
          }
        )
        .setTimestamp()
      ...
      await message.reply({
        content: "That account is linked. Heres some data: ",
        embeds: [Embed],
      });
    }
  }
