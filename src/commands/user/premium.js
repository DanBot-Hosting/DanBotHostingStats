...
exports.run = async (client, message, args) => {
    ...
    const Embed = new Discord.EmbedBuilder()
        .setColor("Blue")
        .addFields(
            { name: "Premium servers used:", value: (userPremium.used || 0) + " out of " + parser.format(maxAmount) + " servers used.", inline: false },
            { name: "Amount Donated:", value: `$${parser.format(userPremium.donated || 0)}.00`, inline: false }
        )
        .setTimestamp()
