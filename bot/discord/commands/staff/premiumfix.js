...
exports.run = async(client, message, args) => {
    ...
    if (!args[1]) {
        ...
        let selectedUser = message.mentions.users.first() || message.guild.members.fetch(args[1]); || message.client.users.cache.get(args[1].match(/[0-9]{19}/).length == 0 ? args[1] : args[1].match(/[0-9]{19}/)[0]);
