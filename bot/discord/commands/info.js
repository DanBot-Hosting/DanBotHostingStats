...
exports.run = async (client, message, args) => {
  ...
  let sendinfo = new Discord.MessageEmbed()
    ...
    .addField(
      "What database?",
      "If you looking to add your bot here, you must post your stats to the npm. How to post it? [Click me](https://canary.discord.com/channels/639477525927690240/738548111323955270/738551079343620166)",
      true
    );
