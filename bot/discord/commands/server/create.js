        ...
        .catch((error) => {
          if (error == "Error: Request failed with status code 400") {
            ...
            const embed = new Discord.MessageEmbed()
              ...
              .addField(
                `__**Failed to create a new server**__`,
                `The node is currently offline or having issues, You can check the status of the node in this channel: <#757949242495991918>`
              );
            message.reply(embed);
          } else {
            const embed = new Discord.MessageEmbed()
