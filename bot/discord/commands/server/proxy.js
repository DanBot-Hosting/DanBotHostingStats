            ...
            axios({
                ...
                axios({
                    ...
                    if (ErrorAfterProxy == "Error: Request failed with status code 500") { // Domain not pointing and/or other error
                        ...
                        message.reply('This domain has already been linked. If this is an error, please check you have DNS only mode in Cloudflare. If you don\'t have Cloudflare or you made everything right, please contact Dan!')
                    }
                })
