...
exports.run = async (client, message, args) => {
    ...
    if (!args[1] || !args[2]) {
        ...
        if(dnsCheck.address != "164.132.74.251" || dnsCheck.address != "192.95.42.75") {
