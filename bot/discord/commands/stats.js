exports.run = async (client, message) => {
    ...
    embed.fields.pop()
    embed.addField("__**[Node 1 - Bots, Websites and Databases](https://danbot.host/Node1)**__", "**CPU LOAD**: " + nodeData.fetch("Node1.cpuload") + "% \n**RAM (USED/TOTAL)**: " + nodeData.fetch("Node1.memused") + " / " + nodeData.fetch("Node1.memtotal") + " \n**STORAGE (USED/TOTAL)**: " + nodeData.fetch("Node1.diskused") + " / " + nodeData.fetch("Node1.disktotal") + " \n**UPTIME**: " + nodeData.fetch("Node1.osuptime") + "\n**Servers:** **Total**: " + nodeData.fetch("Node1.dockercontainers") + ", **Running**: " + nodeData.fetch("Node1.dockercontainersrunning") + ", **Stopped**: " + nodeData.fetch("Node1.dockercontainersstopped"), true)
    //embed.addField('\u200b', '\u200b')
    embed.addField("__**[Node 2 - Bots, Websites and Databases](https://danbot.host/Node2)**__", "**CPU LOAD**: " + nodeData.fetch("Node2.cpuload") + "% \n**RAM (USED/TOTAL)**: " + nodeData.fetch("Node2.memused") + " / " + nodeData.fetch("Node2.memtotal") + " \n**STORAGE (USED/TOTAL)**: " + nodeData.fetch("Node2.diskused") + " / " + nodeData.fetch("Node2.disktotal") + " \n**UPTIME**: " + nodeData.fetch("Node2.osuptime") + "\n**Servers**: **Total**: " + nodeData.fetch("Node2.dockercontainers") + ", **Running**: " + nodeData.fetch("Node2.dockercontainersrunning") + ", **Stopped**: " + nodeData.fetch("Node2.dockercontainersstopped"), true)
   // embed.addField('\u200b', '\u200b')
    embed.addField("__**[Node 3 - Gaming](https://danbot.host/Node3)**__", "**CPU LOAD**: " + nodeData.fetch("Node3.cpuload") + "% \n**RAM (USED/TOTAL)**: " + nodeData.fetch("Node3.memused") + " / " + nodeData.fetch("Node3.memtotal") + " \n**STORAGE (USED/TOTAL)**: " + nodeData.fetch("Node3.diskused") + " / " + nodeData.fetch("Node3.disktotal") + " \n**UPTIME**: " + nodeData.fetch("Node3.osuptime") + "\n**Servers**: **Total**: " + nodeData.fetch("Node3.dockercontainers") + ", **Running**: " + nodeData.fetch("Node3.dockercontainersrunning") + ", **Stopped**: " + nodeData.fetch("Node3.dockercontainersstopped"), true)
    embed.addField('\u200b', '\u200b')
    embed.addField("__**[Node 4 - Test](https://danbot.host/Node4)**__ ", "**CPU LOAD**: " + nodeData.fetch("Node4.cpuload") + "% \n**RAM (USED/TOTAL)**: " + nodeData.fetch("Node4.memused") + " / " + nodeData.fetch("Node4.memtotal") + " \n**STORAGE (USED/TOTAL)**: " + nodeData.fetch("Node4.diskused") + " / " + nodeData.fetch("Node4.disktotal") + " \n**UPTIME**: " + nodeData.fetch("Node4.osuptime") + "\n**Servers**: **Total**: " + nodeData.fetch("Node4.dockercontainers") + ", **Running**: " + nodeData.fetch("Node4.dockercontainersrunning") + ", **Stopped**: " + nodeData.fetch("Node4.dockercontainersstopped"), true)
    //embed.addField('\u200b', '\u200b')
    embed.addField("__**[Node 5 - Bots, Websites and Databases](https://danbot.host/Node5)**__ ", "**CPU LOAD**: " + nodeData.fetch("Node5.cpuload") + "% \n**RAM (USED/TOTAL)**: " + nodeData.fetch("Node5.memused") + " / " + nodeData.fetch("Node5.memtotal") + " \n**STORAGE (USED/TOTAL)**: " + nodeData.fetch("Node5.diskused") + " / " + nodeData.fetch("Node5.disktotal") + " \n**UPTIME**: " + nodeData.fetch("Node5.osuptime") + "\n**Servers**: **Total**: " + nodeData.fetch("Node5.dockercontainers") + ", **Running**: " + nodeData.fetch("Node5.dockercontainersrunning") + ", **Stopped**: " + nodeData.fetch("Node5.dockercontainersstopped"), true)
    //embed.addField('\u200b', '\u200b')
    embed.addField("__**[Node 6 - Bots, Websites and Databases](https://danbot.host/Node6)**__ ", "**CPU LOAD**: " + nodeData.fetch("Node6.cpuload") + "% \n**RAM (USED/TOTAL)**: " + nodeData.fetch("Node6.memused") + " / " + nodeData.fetch("Node6.memtotal") + " \n**STORAGE (USED/TOTAL)**: " + nodeData.fetch("Node6.diskused") + " / " + nodeData.fetch("Node6.disktotal") + " \n**UPTIME**: " + nodeData.fetch("Node6.osuptime") + "\n**Servers**: **Total**: " + nodeData.fetch("Node6.dockercontainers") + ", **Running**: " + nodeData.fetch("Node6.dockercontainersrunning") + ", **Stopped**: " + nodeData.fetch("Node6.dockercontainersstopped"), true)
    embed.addField('\u200b', '\u200b')
    embed.addField("__**[Node 7 - Donator Node](https://danbot.host/Node7)**__ ", "**CPU LOAD**: " + nodeData.fetch("Node7.cpuload") + "% \n**RAM (USED/TOTAL)**: " + nodeData.fetch("Node7.memused") + " / " + nodeData.fetch("Node7.memtotal") + " \n**STORAGE (USED/TOTAL)**: " + nodeData.fetch("Node7.diskused") + " / " + nodeData.fetch("Node7.disktotal") + " \n**UPTIME**: " + nodeData.fetch("Node7.osuptime") + "\n**Servers**: **Total**: " + nodeData.fetch("Node7.dockercontainers") + ", **Running**: " + nodeData.fetch("Node7.dockercontainersrunning") + ", **Stopped**: " + nodeData.fetch("Node7.dockercontainersstopped"), true)
    //embed.addField('\u200b', '\u200b')
    embed.addField("__**[Node 8 - Gaming Node BETA](https://danbot.host/Node8)**__ ", "**CPU LOAD**: " + nodeData.fetch("Node8.cpuload") + "% \n**RAM (USED/TOTAL)**: " + nodeData.fetch("Node8.memused") + " / " + nodeData.fetch("Node8.memtotal") + " \n**STORAGE (USED/TOTAL)**: " + nodeData.fetch("Node8.diskused") + " / " + nodeData.fetch("Node8.disktotal") + " \n**UPTIME**: " + nodeData.fetch("Node8.osuptime") + "\n**Servers**: **Total**: " + nodeData.fetch("Node8.dockercontainers") + ", **Running**: " + nodeData.fetch("Node8.dockercontainersrunning") + ", **Stopped**: " + nodeData.fetch("Node8.dockercontainersstopped"), true)
    //embed.addField('\u200b', '\u200b')
    embed.addField("__**[Node 9 - Bots, Websites and Databases](https://danbot.host/Node9)**__ ", "**CPU LOAD**: " + nodeData.fetch("Node9.cpuload") + "% \n**RAM (USED/TOTAL)**: " + nodeData.fetch("Node9.memused") + " / " + nodeData.fetch("Node9.memtotal") + " \n**STORAGE (USED/TOTAL)**: " + nodeData.fetch("Node9.diskused") + " / " + nodeData.fetch("Node9.disktotal") + " \n**UPTIME**: " + nodeData.fetch("Node9.osuptime") + "\n**Servers**: **Total**: " + nodeData.fetch("Node9.dockercontainers") + ", **Running**: " + nodeData.fetch("Node9.dockercontainersrunning") + ", **Stopped**: " + nodeData.fetch("Node9.dockercontainersstopped"), true)
    embed.addField('\u200b', '\u200b')
    embed.addField("__**[Node 10 - Bots, Websites and Databases](https://danbot.host/Node10)**__ ", "**CPU LOAD**: " + nodeData.fetch("Node10.cpuload") + "% \n**RAM (USED/TOTAL)**: " + nodeData.fetch("Node10.memused") + " / " + nodeData.fetch("Node10.memtotal") + " \n**STORAGE (USED/TOTAL)**: " + nodeData.fetch("Node10.diskused") + " / " + nodeData.fetch("Node10.disktotal") + " \n**UPTIME**: " + nodeData.fetch("Node10.osuptime") + "\n**Servers**: **Total**: " + nodeData.fetch("Node10.dockercontainers") + ", **Running**: " + nodeData.fetch("Node10.dockercontainersrunning") + ", **Stopped**: " + nodeData.fetch("Node10.dockercontainersstopped"), true)
    //embed.addField('\u200b', '\u200b')
    embed.addField("__**[Storage 1 - Storage](https://danbot.host/Storage1)**__ ", "**CPU LOAD**: " + nodeData.fetch("Storage1.cpuload") + "% \n**RAM (USED/TOTAL)**: " + nodeData.fetch("Storage1.memused") + " / " + nodeData.fetch("Storage1.memtotal") + " \n**STORAGE (USED/TOTAL)**: " + nodeData.fetch("Storage1.diskused") + " / " + nodeData.fetch("Storage1.disktotal") + " \n**UPTIME**: " + nodeData.fetch("Storage1.osuptime") + "\n**Servers**: **Total**: " + nodeData.fetch("Storage1.dockercontainers") + ", **Running**: " + nodeData.fetch("Storage1.dockercontainersrunning") + ", **Stopped**: " + nodeData.fetch("Storage1.dockercontainersstopped"), true)
    embed.addField('\u200b', '\u200b')
