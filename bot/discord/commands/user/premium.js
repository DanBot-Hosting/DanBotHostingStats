...
exports.run = async (client, message, args) => {
    ...
    let allowed = Math.floor((user.donated || 0) / config.node7.price) + ((boosted != null && boosted.data[userid] != null) ? Math.floor(boosted.data[userid] * 2.5) : ((member.roles.cache.get('710208090741539006') != null) ? 2 : 0));
    ...
    if (boosted == null && member.roles.cache.get('710208090741539006') != null) {
