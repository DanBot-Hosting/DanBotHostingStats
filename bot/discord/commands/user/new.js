...
exports.run = async (client, message, args) => {
  ...
  let questions = [
    {
      id: "username",
      question:
        "What should your username be? (**Please dont use spaces or special characters**)", // The questions...
  ...
  let category = message.guild.channels.cache.find(
    (c) =>
      c.id === settings.fetch("accountcategory.id") && c.type === "category"
  );
