...
module.exports = async (client, guild, files) => {
    ...
    setInterval(async () => {
        ...
        client.channels.get("739821447924416562").edit({ name: `Tickets: ${ticketcount}`, reaon: "Ticket count update"})
        ...
        client.channels.get("757199549977722890").edit({ name: `Servers Hosting: ${response.data.meta.pagination.total}`, reaon: "Server count update"})
        });
        ...
        client.channels.get("757222585015599214").edit({ name: `Clients Hosting: ${response.data.meta.pagination.total}`, reaon: "Client count update"})
        });
    }, 30000);
};