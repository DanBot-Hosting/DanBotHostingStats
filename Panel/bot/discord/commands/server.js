...
exports.run = async (client, message, args) => {
    ...
    if (!args[0]) {
        ...
        if (message.member.roles.cache.find('710208090741539006' | '788193704014905364' | '793549158417301544') === null) {
            message.channel.send('You are not allowed to use this. F')
        } else if (message.member.roles.cache.find('710208090741539006' | '788193704014905364' | '793549158417301544')) {
